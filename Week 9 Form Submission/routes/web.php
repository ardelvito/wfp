...
Route::get('/transactions/productform', [TransactionController::class, 'showProductForm'])->name('transactions.productform');
Route::post('/transactions/insertproduct', [TransactionController::class, 'insertProductTransaction'])->name('transactions.insertproduct');
